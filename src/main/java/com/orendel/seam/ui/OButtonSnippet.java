...
import org.mihalis.opal.obutton.OrangeButtonRenderer;
import org.mihalis.opal.obutton.PurpleButtonRenderer;
...
public class OButtonSnippet {
	...
	public static void main(final String[] args) {
		...
		icon = new Image(display, OButtonSnippet.class.getClassLoader().getResourceAsStream("bar_chart_16.png"));
